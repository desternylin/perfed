...
class MeFairClient(Client):
    def __init__(self, cid, train_data, test_data, options):
        ...
        self.q = options['q']
        super(MeFairClient, self).__init__(cid, train_data, test_data, options)
    ...
    def local_train(self):
        ...
        for local_round in range(self.num_local_round):
            ...
            self.local_model = self.local_model - self.local_lr * self.lamda * (cur_loss**self.q) * (self.local_model - self.person_model_params)
    ...
    #     flat_grads = self.lamda * (cur_loss**(self.q)) * (self.local_model - self.person_model_params)
    #     return flat_grads
